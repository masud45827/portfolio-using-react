  ...
  return (
    <div className="p-4 bg-indigo-50">
      <div className="flex flex-col items-center justify-center ">
        <h1 className="pt-2 w-3/4 pb-5 text-3xl text-center">Experience</h1>
      ...
      <div>
        <div className="flex flex-col justify-center items-center p-5 text-3xl">
          <h1 className="py-4">Professional Experience</h1>
          <h1 className="font-bold">0</h1>
        </div>

        <div className="pt-5">
          <h1 className="text-center text-3xl p-5">Work Experience</h1>
          <h1 className="text-2xl p-2"><span className="text-3xl font-bold">Programming:</span> I have solved 3500+ problems in different online judges.</h1>
          <h1 className="text-3xl p-2 pt-5 font-bold text-center">Online judges: </h1>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {OnlineJudge.map((o, index) => (
              <ProblemSolved key={index} name={o.name} handle={o.handle} solved={o.solved} link={o.link} />
            ))}
          </div>

          <h1 className="p-2 font-bold pt-10 text-3xl text-center">Onsite Contest Achievements: </h1>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <h1 className="p-2 font-bold pt-10 text-3xl text-center">Projects: </h1>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
