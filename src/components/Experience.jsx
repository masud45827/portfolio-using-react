...
//     if (ref.current) {
//       const scrollAmount = ref.current.querySelector(".box").offsetWidth * 3; // Adjust this value to scroll by 3 boxes at a time
...
//             <button onClick={() => scroll(scrollRef1, "left")} className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">←</button>
//             <div ref={scrollRef1} className="flex gap-4 overflow-x-auto max-w-full py-2">
//               {OnlineJudge.map((o, index) => (
//                 <div className="box flex-shrink-0 w-80" key={index}>
//                   <ProblemSolved name={o.name} handle={o.handle} rating={o.max_rating} solved={o.solved} link={o.link} />
//                 </div>
//               ))}
//             </div>
//             <button onClick={() => scroll(scrollRef1, "right")} className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">→</button>
//           </div>

//           <h1 className="p-2 font-bold pt-10 text-2xl text-center">Onsite Contest Achievements: </h1>

//           <div className="relative">
//             <button onClick={() => scroll(scrollRef2, "left")} className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">←</button>
//             <div ref={scrollRef2} className="flex gap-4 overflow-x-auto max-w-full py-2">
//               {onSiteContest.map((contest, index) => (
//                 <div className="box flex-shrink-0 w-80" key={index}>
//                   <OnsiteContestCard name={contest.name} rank={contest.rank} teamName={contest.teamName} link={contest.link} />
//                 </div>
//               ))}
//             </div>
//             <button onClick={() => scroll(scrollRef2, "right")} className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">→</button>
//           </div>

//           <h1 className="p-2 font-bold pt-10 text-2xl text-center">Projects: </h1>

//           <div className="relative">
//             <button onClick={() => scroll(scrollRef3, "left")} className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">←</button>
//             <div ref={scrollRef3} className="flex gap-4 overflow-x-auto max-w-full py-2">
//               {projects.map((project, index) => (
//                 <div className="box flex-shrink-0 w-80" key={index}>
//                   <ProjectLink name={project.name} technology={project.technology} link={project.link} />
//                 </div>
//               ))}
//             </div>
//             <button onClick={() => scroll(scrollRef3, "right")} className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gray-200 p-2 rounded">→</button>
//           </div>
//         </div>
